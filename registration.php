...
<html>
	...
	<body>
		...
		<h2 align="center">Smarto Registration Details</h2>
		<ul class="topnav">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="license" type="text"  placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="registration" type="text"  placeholder="" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="insurance" type="text"  placeholder="" required>
						</div>
					</div>
