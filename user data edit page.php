...
<html>
	...
	<body>
		...
		<h2 align="center">Smarto User Data Edit Page</h2>
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="license" type="text"  placeholder="" value="<?php echo $data['license_number'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="registration" type="text"  placeholder="" value="<?php echo $data['registration_number'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="insurance" type="text"  placeholder="" value="<?php echo $data['insurance_number'];?>" required>
						</div>
					</div>
