					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr>
									<td align="left" class="lf">License Number</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['license_number'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Registration Number</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['registration_number'];?></td>
								</tr>
								<tr>
									<td align="left" class="lf">Insurance Number</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['insurance_number'];?></td>
								</tr>
							</table>
						</td>
					</tr>
